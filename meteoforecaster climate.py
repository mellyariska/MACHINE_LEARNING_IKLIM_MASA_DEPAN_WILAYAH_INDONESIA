...
if missing:
    st.error(f"❌ Kolom wajib hilang: {missing}. Harap periksa file SUMSEL.xlsx Anda.")
    st.stop()
...
st.subheader("🌤️ Klasifikasi Cuaca Berdasarkan Threshold")
...
# --- MACHINE LEARNING ---
st.subheader("🤖 Prediksi Cuaca Menggunakan Random Forest")
...
# Train-test split aman meski data sedikit
try:
...
st.code(classification_report(y_test, pred_test, zero_division=0))

# Prediksi ke seluruh dataset
...
# --- DOWNLOAD HASIL ---
st.subheader("📥 Unduh Hasil Analisis & Prediksi")
